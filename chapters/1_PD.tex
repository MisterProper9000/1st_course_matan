...
\begin{figure}[h!]
\center{\includegraphics[scale=0.4]{pictures/sec1subgraphicotobr.eps}}
\end{figure}
...
\begin{figure}[h]
\center{\includegraphics[scale=0.7]{pictures/sec1complitnessaxiom.eps}}
\end{figure}
...
\begin{figure}[h]
\center{\includegraphics[scale=0.7]{pictures/sec1geominterpr.eps}}
\end{figure}
